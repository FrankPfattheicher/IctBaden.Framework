...
namespace IctBaden.Framework.AppUtils
{
    public class SingletonApp
    {
        ...
        public static bool IsAlreadyRunning()
        {
            ...
            var thisName = thisProcess.ProcessName;
            var runningProcessList = Process.GetProcessesByName(thisName);
            if (runningProcessList.Length <= 1) return false;

            foreach (var process in runningProcessList)
            {
